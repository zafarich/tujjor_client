...
module.exports.__inject__ = function (context) {
  add("5a1c1a26", content, true, context)
};
...
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_nuxt_webpack_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_sass_resources_loader_lib_loader_js_ref_7_oneOf_1_4_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_CatalogMagazinesMainPage_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(184);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_nuxt_webpack_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_sass_resources_loader_lib_loader_js_ref_7_oneOf_1_4_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_CatalogMagazinesMainPage_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_nuxt_webpack_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_sass_resources_loader_lib_loader_js_ref_7_oneOf_1_4_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_CatalogMagazinesMainPage_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_nuxt_webpack_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_sass_resources_loader_lib_loader_js_ref_7_oneOf_1_4_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_CatalogMagazinesMainPage_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_nuxt_webpack_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_sass_resources_loader_lib_loader_js_ref_7_oneOf_1_4_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_CatalogMagazinesMainPage_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/CatalogMagazinesMainPage.vue?vue&type=template&id=09d94040&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('section',[(!_vm.isGet)?_c('base-loading'):_vm._e(),_vm._ssrNode(" "),(_vm.isGet)?_vm._ssrNode("<section class=\"magazines__main__page\">","</section>",[_vm._ssrNode("<section class=\"container popular__container\"><div class=\"popular__heading\">"+_vm._ssrEscape(_vm._s(_vm.$t("magazine")))+"</div></section> "),_vm._ssrNode("<div class=\"magazines__box container\">","</div>",[_vm._ssrNode("<div class=\"card-row \">","</div>",_vm._l((_vm.magazines),function(magazine){return _vm._ssrNode("<div class=\"card-3 \">","</div>",[_c('nuxt-link',{attrs:{"to":{
                            name: ("magazine-id___" + (_vm.$i18n.locale)),
                            params: { id: magazine.slug }
                        }}},[_c('div',{staticClass:"shops-card hover-shadow"},[_c('h1',[_vm._v(_vm._s(magazine.shopName))]),_vm._v(" "),_c('p',[_vm._v("\n                                "+_vm._s(magazine.description[_vm.$i18n.locale])+"\n                            ")]),_vm._v(" "),_c('div',{staticClass:"shop-image"},[_c('img',{attrs:{"src":magazine.image,"alt":""}})])])])],1)}),0)]),_vm._ssrNode(" "+((_vm.limit > _vm.magazines.length)?("<section id=\"btn__box\" class=\"container popular__container\"><a href=\"#\" class=\"popular__btn text-center\">"+_vm._ssrEscape(_vm._s(_vm.$t("all")))+"</a></section>"):"<!---->"))],2):_vm._e()],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./components/CatalogMagazinesMainPage.vue?vue&type=template&id=09d94040&

// EXTERNAL MODULE: ./components/UI/BaseLoading.vue + 4 modules
var BaseLoading = __webpack_require__(85);

// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/CatalogMagazinesMainPage.vue?vue&type=script&lang=js&
//
//
//
//
...
//
//
/* harmony default export */ var CatalogMagazinesMainPagevue_type_script_lang_js_ = ({components:{BaseLoading: BaseLoading["default"]},data(){return{isGet:false,magazineCount:0,increaseBy:0,magazines:[],limit:0};},beforeMount(){const winWidth=window.innerWidth;if(winWidth<=530){this.magazineCount=this.increaseBy=4;}else{this.magazineCount=this.increaseBy=3;}},methods:{async fetchMagazines(){const page=1;const limit=this.magazineCount;const response=await this.$axios.$get("shop/all/filter?page="+page+"&limit="+limit).then(res=>{if(!!res.success){return res;}else{throw new Error("Couldn't fetcg data");}}).catch(error=>console.error(error));return response;},async updateMagazineLimit(){this.magazineCount+=this.increaseBy;const data=await this.fetchMagazines();this.magazines=data.data[0].data;},//  go to magazine on click card of magazine
goToMagazine(slug){this.$router.push({path:"/magazine/"+slug,params:{id:slug}});}},async mounted(){const data=await this.fetchMagazines();this.magazines=data.data[0].data;this.limit=data.data[0].count;console.log("magazine",this.magazines);this.isGet=true;}});
// CONCATENATED MODULE: ./components/CatalogMagazinesMainPage.vue?vue&type=script&lang=js&
 /* harmony default export */ var components_CatalogMagazinesMainPagevue_type_script_lang_js_ = (CatalogMagazinesMainPagevue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(2);

// CONCATENATED MODULE: ./components/CatalogMagazinesMainPage.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  components_CatalogMagazinesMainPagevue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  injectStyles,
...
/* harmony default export */ var CatalogMagazinesMainPage = __webpack_exports__["default"] = (component.exports);
...
//# sourceMappingURL=catalog-magazines-main-page.js.map