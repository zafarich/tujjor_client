<template>
    <section class="all_magazine__section">
        ...
        <section class="container popular__container magazin__container">
            <div class="popular__heading">Все магазины</div>
        ...
        <div class="magazines__box container">
            <div
                ...
                v-for="magazine in magazinesData"
                :key="magazine.companyId"
            >
            ...
            <div class="magazine__item__box">
                ...
                <div class="magazine__item--description">
                    <span>
                        Качественная и доступная обувь все возможные товары
                        только для вас
                    </span>
                </div>
                <div class="magazine__item__img__box">
            ...
            <div class="magazine__item__box">
                ...
                <div class="magazine__item--description">
                    <span>
                        У нас самые дорогие и лучшие автомобили
                    </span>
                </div>
                <div class="magazine__item__img__box">
                    <div class="magazine__item__img--first">
            ...
            <div class="magazine__item__box">
                ...
                <div class="magazine__item--description">
                    <span>
                        Если вас интересует одежда в классическом стиле, добро
    ...
    .magazin__container {
        ...
        .popular__dropdown__box {
            ...
            .popular__dropdown--btn {
                ...
                &:hover + .popular__dropdown__content {
                    visibility: visible;
                    opacity: 1;
                }
            }
            .popular__dropdown__content {
                position: absolute;
                left: 0;
                top: 36px;
                width: 170px;
