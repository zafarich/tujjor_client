    ...
    <section class="magazine__section">
            ...
            <div class="container">
                <div class="title-box">
                    <ul>
                        ...
                        <li>
                            <nuxt-link to="/rubashki">Все магазины</nuxt-link>
                            /
                        </li>

                        <li>
                            <nuxt-link to="/rubashki">Аристокракта</nuxt-link>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <section class="catalog__container container">
            <div class="catalog__filtraiton__box">
                <section
                    class="popular__container catalog__dropdown__container"
                >
                    <div class="popular__dropdown__box">
                        ...
                        <div class="popular__dropdown__content">
                            <a href="#" class="popular__dropdown--link"
                                >По дате</a
                            >
                            <a href="#" class="popular__dropdown--link"
                                >По рейтинг</a
