export default {
    ...
    poiskdog: "Shartnoma raqamini qidirish",
    numdog: "Shartnoma raqami",
    fio: "F.I.O",
    nazfilm: "Firma nomi",
    bankrek: "Bank rekvizitlari",
    mfo: "MFO",
    adres: "Manzil",
    imyabank: "Bank nomi",
    inn: "INN  ",
    email: "Email",
    shartnot: "Shartnoma topilmadi !!!",
    shart: "Shartnoma:",
    shartyuk: "Shartnomani yuklang",
    filechoose: "Fayni tanlash",
    guv: "Guvohnoma:",
    guvyuk: "Guvohnomani yuklang",
    sendx: "Yuborish",
    zapuspeshno: "So'rovingiz muvaffaqiyatli yuborildi",
    ok: "OK!",
    fullname: "To'liq ism",
    elpoch: "Elektron pochta",
    sobsheniya: "Xabar",
    viuje: "Siz allaqachon so'rov yuborgansiz, ma'lumotlaringizni o'zgartirmoqchimisiz?",
    net: "Yo'q!",
    da: "Ha!",
    poldog: " Shartnoma oling",
    estdog: "Menda shartnoma bor",
    zagdog: " Iltimos, kelishuv va litsenziyangizni yuklang.",
    udog: "Sizda shartnoma yo'qmi?",
